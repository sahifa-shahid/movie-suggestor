            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 2, backgroundColor: '#DD1515' }}>
                        <View style={{ flex: 0.75, marginTop: 20 }}>
                            <TextInput
                        ...
                        <View style={{ flex: 0.5, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            <Text style={styles.subtitle}>Enter Age:</Text>
                            <Picker
                                selectedValue={selectedValue}
                                onValueChange={(itemValue) => setSelectedValue(itemValue)}
                                style={{ flex: 2.5 }}
                                itemStyle={styles.dropdown}>
                                <Picker.Item label="Under 18" value="2young" />
                                <Picker.Item label="18+" value="adult" />
                            </Picker>
                        </View>
                        <View style={{ flex: 0.75, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            <TextInput
                                ...
                                style={{
                                    fontFamily: 'Raleway-Regular',
                                    fontSize: 17, marginLeft: 25, borderBottomWidth: 1, borderColor: 'black', marginRight: 25, flex: 3
                                }}
